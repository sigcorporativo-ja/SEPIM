...
public interface UserService {
	...
	void deleteUser(String userName) throws AppMovCDAUException;

	User updateUser(String userName, String password, String name)
			throws AppMovCDAUException;

	User getUser(String userName) throws AppMovCDAUException;

	boolean existsUser(String userName);

	List<User> getAll();

	User updateUserRoles(String userName, String[] roles)
			throws AppMovCDAUException;
