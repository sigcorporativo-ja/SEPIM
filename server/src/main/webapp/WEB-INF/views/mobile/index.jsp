    ...
    <body>
		...
		<div data-role="page" id="inicio">
			...
			<div role="main" class="ui-content">
				...
				<a id="btn-buscar" class="ui-btn ui-shadow ui-corner-all ui-btn-b" data-direction="reverse" href="javascript:cargarCategoria()">Búsqueda por categoría</a>
				<!--<a class="ui-btn ui-shadow ui-corner-all ui-btn-b" data-direction="reverse" href="#busqueda">Búsqueda por texto libre</a>-->
